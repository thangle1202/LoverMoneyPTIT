...
public class SelectGroupCashOutAdapter extends RecyclerView.Adapter {

    private List<Group> groups;
    private Context mContext;
    private View.OnClickListener mOnClickListener;

    public SelectGroupCashOutAdapter(List<Group> groups, Context mContext) {
        this.groups = groups;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        SelectGroupCashOutAdapter.MyViewHolder myViewHolder = (SelectGroupCashOutAdapter.MyViewHolder) holder;
